    ...
    <section id="ongoing-project" className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="relative">
          ...
          {/* Card overlaid on the right of the image (desktop) / below on mobile */}
          <Reveal
            delay={0.15}
            className="md:absolute md:top-1/2 md:right-6 lg:right-10 md:-translate-y-1/2 md:w-[440px] lg:w-[500px] -mt-16 md:mt-0 px-4 md:px-0 z-10"
          >
